...
LOAD DATA LOCAL INFILE '/home/ubuntu/CSE356_HW7/upto7999.csv' INTO TABLE hw7.electric FIELDS TERMINATED BY ',' LINES TERMINATED BY '\n';
LOAD DATA LOCAL INFILE '/home/ubuntu/CSE356_HW7/next2000.csv' INTO TABLE hw7.electric FIELDS TERMINATED BY ',' LINES TERMINATED BY '\n';

LOAD DATA LOCAL INFILE 'C:/Users/Kevin/Desktop/cse356/homeworks/hw7/uptorest.csv' INTO TABLE hw7.electric FIELDS TERMINATED BY ',' LINES TERMINATED BY '\n';